...
<template>
  <article class="group flex min-h-14 items-center gap-3 border-b border-slate-200 bg-white px-4 py-2 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800">
    <button
